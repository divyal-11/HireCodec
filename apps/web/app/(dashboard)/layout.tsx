...
import {
  ...
  BarChart3, Settings, LogOut, Menu, X, Plus, ChevronDown,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-dash-bg flex">
      ...
      >
        ...
        <div className="border-t border-editor-border p-3 space-y-1">
          <div className={cn(
            ...
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                <p className="text-xs font-medium text-editor-text truncate">John Doe</p>
                <p className="text-[10px] text-editor-comment truncate">Interviewer</p>
              </div>
            )}
          </div>
          ...
          <button
            onClick={() => {
              // TODO: In production, call NextAuth signOut()
